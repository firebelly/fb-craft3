<?php
/**
 * redactor-alignment plugin for Craft CMS 3.x
 *
 * Plugin to add redactor alignment plugin to redactor
 *
 * @link      firebellydesign.com
 * @copyright Copyright (c) 2019 Firebelly
 */

namespace firebelly\redactoralignment;
 ...
 *
 * @author    Firebelly
 * @package   Redactoralignment
 * @since     1.0.0
 *
 */
class Redactoralignment extends Plugin
{
    // Static Properties
    // =========================================================================
     ...
     * Redactoralignment::$plugin
     *
     * @var Redactoralignment
     */
            ...
            function (PluginEvent $event) {
                if ($event->plugin === $this) {
                    ...
                    if ( craft()->request->isCpRequest() && craft()->userSession->isLoggedIn() )
                    {
                      ...
                      craft()->templates->includeJsResource('redactoralignment/src/js/alignment.js');
                    }
                }
            }
        );
